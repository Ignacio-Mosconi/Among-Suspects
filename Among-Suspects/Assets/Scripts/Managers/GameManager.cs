...
public class GameManager : MonoBehaviour
{
    ...
    {     
        ...
        if (button && button.interactable)
        {
            ...
            AudioManager.Instance.PostEvent("Menu_Posicionar_Cursor");
        }
    }
    ...
    IEnumerator InvokeScaledTime(Action action, float waitTime)
    {
    ...
    public void InvokeMethodInScaledTime(Action action, float waitTime)
    {
        StartCoroutine(InvokeScaledTime(action, waitTime));
    }
